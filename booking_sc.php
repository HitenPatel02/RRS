...
$fetch = mysqli_fetch_array($query);
      ...
      // echo "<br><b>distion".$_SESSION["distion"]."/KM</b> ";
       ...
       $_SESSION['cgackprise'] = $fetch['sc_prise'];
...
?>
    ...
    <form action="Review_sc.php" method="post">
    <div class="full">
      <div class="yy">
        <ul>
    ...
    <br><br>  
    <div id="reg"><br>
       <p id="p1"> <?php echo $_SESSION['class'];?> ₹<?php echo $fetch['sc_prise'];?>&nbsp;// Available <?php echo $seta;?></p>
     <?php
      }else{
