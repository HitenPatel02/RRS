...
foreach ($options4 as $option3) {
    ...
    echo "<td>".$option3['available_set']."</td>";
    echo "<td>".$option3['Frist_Class']."</td>";
    echo "<td>".$option3['Second_Class']."</td>";
    echo "<td>".$option3['Third_Class']."</td>";
