...
<head>
   <title>website</title>
   <link rel="stylesheet" href="style___available.css"/>
</head>
...
// $_SESSION['frome'] = $_POST['red'];
// $_SESSION['to'] = $_POST['yer'];
       ...
       <option for value="from"><?php echo $red;?></option>
        <?php 
         foreach ($options as $option) {
             ...
             echo "<option>" .$option['station']."</option>";            
                  }
              ?>
...
<br><table>
    <form action="pasanger.php" method="POST">
        <?php
         ...
         $_SESSION['Secund_Class']=$row['Secund_Class'];
         $_SESSION['Tard_Calss']=$row['Tard_Calss'];
...
<input type="submit" value="Show Availability"/>    
   ...
   <?php echo " <input type='hidden' name='available_set' value='".$_SESSION['available_set']."'>"; ?>
   
                <button type="submit"  name="pris" value="<?php echo $_SESSION['pris'] ;?>">₹<?php echo $row['pris'];?>
            <br>Ave <?php echo $row['available_set'];?></button>
            <button type="submit" name="cc">₹<?php echo $row['fc_pris'];?>
            <br>Ave <?php echo $row['Frist_Class'];?></button>
            <button type="submit"  name="2s">₹<?php echo $row['sc_prise'];?>
            <br>Ave <?php echo $row['Secund_Class'];?></button>
            <button type="submit" name="cc">₹<?php echo $row['tc_pris'];?>
            <br>Ave <?php echo $row['Tard_Calss'];?></button>
                </form>
</div>
